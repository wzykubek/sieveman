...
func parseResponse(line string) (Response, error) {
	...
	switch resp {
	case "OK":
		return ResponseOK{code: code, msg: msg}, nil
	case "NO":
		return ResponseNO{code: code, msg: msg}, nil
	case "BYE":
		return ResponseBYE{code: code, msg: msg}, nil
	default:
		return nil, nil
	}
}

func parseResponseCode(codeStr string) (ResponseCode, error) {
	if codeStr == "" {
		return nil, nil
	}
	...
	switch code {
	case "TAG":
		return Tag{msg: msg, child: nil}, nil
	default:
		return nil, nil
	}
}
